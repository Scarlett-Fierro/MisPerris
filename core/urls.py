...
from .views import home, formulario, login, listar_mascotas, eliminar_mascota, formulario_mascota, modificar_mascota #Estamos importando la funcion "home" y la funcion "formulario " que hicimos en views
